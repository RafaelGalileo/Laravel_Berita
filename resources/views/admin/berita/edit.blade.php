...
@section('title') Edit Berita - {{ config('app.name', 'Laravel') }} @endsection
						...
						<div class="card-body">
							<form action="{{ route('update_berita', $berita->id) }}" method="post" enctype="multipart/form-data">
								...
								<div class="text-center">
									<img src="{{ asset('uploads/berita/'.$berita->gambar) }}" alt="" width="200px" id="one" style="...">
								</div>
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="hidden" name="current_image" value="{{ $berita->gambar }}">
									...
									<div class="col-sm-12">
										<div class="form-group">
											...
											<input class="form-control" type="text" name="judul_berita" value="{{ $berita->judul_berita }}">
										</div>
									</div>
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<textarea name="konten_berita" id="konten_berita" cols="30" rows="10" class="form-control">
									...
									<div class="col-md-6">
										<div class="form-group">
											<div class="form-check" data-children-count="1">
												...
												@if($berita->status==1) checked @endif>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input name="seo_title" id="seo_title" class="form-control" value="{{ $berita->seo_title }}"></input>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input name="seo_subtitle" id="seo_subtitle" class="form-control" value="{{ $berita->seo_subtitle }}"></input>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input name="seo_keywords" id="seo_keywords" class="form-control" value="{{ $berita->seo_keywords }}"></input>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input name="seo_deskripsi" id="seo_deskripsi" class="form-control" value="{{ $berita->seo_deskripsi }}"></input>
										</div>
									</div>
								</div>
